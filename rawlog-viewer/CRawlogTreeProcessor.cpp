...
void CRawlogTreeProcessor::getTreeIndex()
{
 ...
 */
void CRawlogTreeProcessor::getTreeDataPoint(size_t index) const
{

  if (index < (int)m_tree_nodes.size() && index >=0) {
    mainDisplayProcessor(m_tree_nodes[index].data, m_rawlog);
  }
}
